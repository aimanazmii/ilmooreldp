      ...
      <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div className=" text-left">
          <div className="text-3xl text-blue-900 font-extrabold leading-tight  sm:text-4xl lg:text-5xl lg:leading-tight">
            A K-12 curriculum built with <br /> intention
          </div>
          <p className="text-md text-regular leading-relaxed text-gray-900 mt-5">
            The future shines bright for students—Stride Learning Solutions
            thoughtfully <br />
            builds their academic journey with a core curriculum that expands to
            the highest levels.  
          </p>
        </div>
        ...
        <div className="grid max-w-xl grid-cols-1 mx-auto mt-8 text-center lg:max-w-full sm:mt-12 lg:mt-20 lg:grid-cols-3 gap-x-6 xl:gap-x-12 gap-y-6">
          <Card className="mt-6 w-96 bg-sky-100 shadow-lg">
            <CardBody>
              <img
...
/* <div className="gap-8 items-center py-8 px-4 mx-24 max-w-screen-xl xl:gap-16 md:grid md:grid-cols-1 sm:py-16 lg:px-6 md:flex-row flex-col md:items-start md:text-left text-center">
  <div className="px-20 py-20 text-left">
    ...
    <p className="text-md text-regular leading-relaxed text-gray-900 mt-5">
      The future shines bright for students—Stride Learning Solutions
      thoughtfully <br />
      builds their academic journey with a core curriculum that expands to the
      highest levels.  
    </p>
  </div>
</div>; */
